...
public class HPCharacter
{
    ...
    public HPCharacter( String name, List<String> alternate_names, String species, String gender,
                        String house, String dateOfBirth, Integer yearOfBirth, Boolean wizard,
                        String ancestry, String eyeColour, String hairColour, Wand wand, String patronus,
                        Boolean hogwartsStudent, Boolean hogwartsStaff, String actor, List<String> alternate_actors,
                        Boolean alive, String image )
    {
        this.name = name;
